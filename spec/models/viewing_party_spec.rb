...
RSpec.describe ViewingParty, type: :model do
  before(:each) do
    @user_1 = User.create!(name: 'Sam', email: 'sam@email.com', password: Faker::Internet.password)
    @user_2 = User.create!(name: 'Tommy', email: 'tommy@email.com', password: Faker::Internet.password)
